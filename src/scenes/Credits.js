...
export default class Credits extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(canvasWidth / 2, 160, getPhrase(this.programmers), {
        fontSize: "128px",
      ...
      .setOrigin(0.5);
    this.add
      .text(canvasWidth / 2, 520, getPhrase(this.artist), {
        fontSize: "128px",
        fontFamily: "Trebuchet MS",
        fill: "FFFF00",
      })
      .setOrigin(0.5);
    this.add
      .text(canvasWidth / 2, 300, "Sebastian Faetani", {
        fontSize: "50px",
        fontFamily: "Trebuchet MS",
        fill: "FFFF00",
      })
      .setOrigin(0.5);
    this.add
      .text(canvasWidth / 2, 400, "Agustin Iñiguez", {
        fontSize: "50px",
        fontFamily: "Trebuchet MS",
        fill: "FFFF00",
      })
      .setOrigin(0.5);
    this.add
      .text(canvasWidth / 2, 630, "Sasha Flory", {
        fontSize: "50px",
        fontFamily: "Trebuchet MS",
        fill: "FFFF00",
      })
